...
## Appendix: Workshop Schedule (1.5 hours)

| Time | Topic | Duration |
|------|-------|----------|
| 0:00-0:10 | Introduction & Imputation Overview | 10 min |
| 0:10-0:30 | Data Preparation & Job Submission (hands-on) | 20 min |
| 0:30-1:00 | Imputation Workflow & Monitoring (hands-on) | 30 min |
| 1:00-1:20 | Quality Assessment - R² Distribution (hands-on) | 20 min |
| 1:20-1:30 | GWAS Visualization & Wrap-up | 10 min |
...
*This tutorial was developed for the 1st African Genomics Short Course - Cape Town 2025.*
